...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none hover:-translate-y-[1px] hover:shadow-sm focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-0 active:not-aria-[haspopup]:shadow-none disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        edu: "bg-primary text-primary-foreground hover:bg-[color-mix(in_oklch,var(--primary),var(--foreground)_5%)] border border-primary/20",
        "edu-outline": "border border-border bg-background text-foreground hover:bg-muted",
      ...
      size: {
        ...
        edu: "h-9 gap-1.5 rounded-xl px-4 text-xs font-bold uppercase tracking-wider",
        "edu-sm": "h-8 gap-1.5 rounded-lg px-3 text-[11px] font-bold uppercase tracking-wider",
        icon: "size-8",
        "icon-xs":
