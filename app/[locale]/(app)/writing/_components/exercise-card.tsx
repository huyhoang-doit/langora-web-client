...
export function ExerciseCard({ exercise }: { exercise: WritingExercise }) {
  ...
  return (
    <div className="card-edu card-edu-interactive p-6 bg-card flex flex-col h-full relative overflow-hidden group">
      ...
      <div className="flex-grow space-y-4 relative z-10">
        <div className="flex justify-between items-start gap-2">
          <div className="w-10 h-10 flex-shrink-0 rounded-xl bg-primary/10 border-2 border-primary/20 flex items-center justify-center text-primary">
          ...
          <div className="flex flex-wrap justify-end gap-1.5">
            ...
            {exercise.contentTypeName && (
              <Badge variant="secondary" className="border-2 font-bold uppercase tracking-wider text-[10px] bg-secondary/50 text-secondary-foreground">
                {exercise.contentTypeName}
              </Badge>
            )}
          </div>
