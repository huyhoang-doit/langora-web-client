      ...
      <div className="w-full max-w-[500px] glass rounded-xl p-8 md:p-10 shadow-sm relative z-10 text-center">
        <header className="mb-8">
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 px-4 py-1.5 rounded-full mb-6 mx-auto">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-primary">Onboarding Step 1 of 6</span>
          </div>
          <h1 className="text-3xl font-bold text-foreground mb-4">Welcome to Langora!</h1>
        ...
        <div className="my-8 py-6 border-y border-border flex justify-around">
          <div className="text-center">
            <div className="text-2xl font-bold text-primary">2 min</div>
            <div className="text-[10px] text-muted-foreground uppercase font-bold">Estimated time</div>
          </div>
          <div className="w-px bg-border" />
          <div className="text-center">
            <div className="text-2xl font-bold text-primary">AI-guided</div>
            <div className="text-[10px] text-muted-foreground uppercase font-bold">Flow style</div>
          </div>
        </div>

        <Link href="/onboarding/select-language" className="block w-full">
          <Button className="w-full py-6 rounded-xl font-bold hover:shadow-[0_0_20px_rgba(168,240,106,0.3)] transition-all flex items-center justify-center gap-2">
            Let's Start
