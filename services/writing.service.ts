...
export const writingService = {
  ...
  // --- Exercises ---
  getExercises: async (topicId?: string): Promise<ApiResponse<WritingExercise[]>> => {
    return axiosInstance.get('/writing-exercises', { params: { topicId } }) as unknown as Promise<ApiResponse<WritingExercise[]>>;
  },
  
  getExerciseById: async (id: string): Promise<ApiResponse<WritingExercise>> => {
    return axiosInstance.get(`/writing-exercises/${id}`) as unknown as Promise<ApiResponse<WritingExercise>>;
  },
